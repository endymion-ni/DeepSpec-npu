...
**Note: DeepSeek-V4-Flash-DSpark** is **not** a new model. It is the same checkpoint with an additional speculative decoding module attached. A minimal inference example is available in the [`inference`](inference/README.md) folder. For more details, refer to: https://github.com/deepseek-ai/DeepSpec
